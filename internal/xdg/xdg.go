...
//
// If $XDG_CONFIG_HOME is unset and os.UserHomeDir fails, home falls back
// to "/" and the returned path becomes "/.config/<app>". Downstream file
// operations will surface a clear
...
// App is the directory name the tool stores things under.
const App = "terrier"
